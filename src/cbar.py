...
def colorbar(im,axis,orientation="vertical",font_size=8,colormap="rainbow",ticks='None',label=None,bbox=(1, 0.0, 1, 1),width="5%",height="100%",label_pad=0, labelsize = 5):
